    ...
    <div class="container section1">
      ...
      <div class="section-content">
        ...
        <div class="section-content-info">
          ...
          <h2 class="section-content__title-loto2">Самые крупные выигрыши в «Русском лото»</h2>
        ...
        <div class="section-content-info">
          ...
          <div class="section-content__title">Где купить билет</div>
        </div>

        <img class="section-content__text-img__cassa" src="@/assets/img/img-sec4.jpg" alt="">
